...
patch -p1 < $HOME/embeddedgo/patch/go1.13.6
cd src
./make.bash
```
Now you have the ready to use go1.13.6 with added support for linux/thumb and noos/thumb
...
You can always revert all changes and return back to the clean go1.13.6 using the following commands:
